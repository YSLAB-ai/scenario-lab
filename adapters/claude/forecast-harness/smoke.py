...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the packaged Claude adapter smoke flow.")
    parser.add_argument("--work-dir")
    args = parser.parse_args()

    work_dir = Path(args.work_dir) if args.work_dir else Path(tempfile.mkdtemp(prefix="forecast-harness-claude-smoke-"))
