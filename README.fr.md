...
Scenario Lab est publié sous la [MIT License](LICENSE).
...
Le logiciel est fourni `as is`, sans garantie, selon les termes de la MIT License. Consultez [LICENSE](LICENSE) et [docs/limitations.md](docs/limitations.md).
